...
Le catalogue des signaux officaux est intégré en tant que mise en page (atlas) dans le projet QGIS. Une version condensée peut directement être téléchargée en [pdf](https://www.signalo.ch/doc/official-sign-fr.pdf).
