...
def create_transifex_config():
    ...
    with open(config_file, "w") as f:
        ...
        for file in glob.iglob(current_dir + '/../documentation/**/*.fr.md', recursive=True):
            ...
            if tx_slug:
                ...
                f.write(f"file_filter = website/{''.join(relative_path.split('.')[:-2])}.<lang>.md\n")
                f.write(f"source_file = website/{relative_path}\n")
